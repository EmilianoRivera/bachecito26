import { createUserWithEmailAndPassword, sendEmailVerification, auth, query, doc, db, collection, getDocs, addDoc, onSnapshot, deleteDoc} from "../JS/firebase.js";
...
adminForm.addEventListener("submit", async (e) => {
    ...
    try {
        ...
        console.log('Administrador registrado con el ID:', uid);
