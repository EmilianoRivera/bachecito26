...
loginForm.addEventListener('submit', async (e) => {
    ...
    try {
        ...
        querySnapshot.forEach((docSnap) => {
            ...
            if (datos) {
                if (datos.rol === 'Admin') {
                    // Redirige a main.html para el administrador
                    window.location.href = "../Principal/estaticosAdmin.html";
                } else {
                    // Redirige a mainU.html para otros usuarios
                    window.location.href = "../Principal/mainU.html";
                }
            } else {
